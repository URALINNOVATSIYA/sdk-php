...
namespace Twin\Sdk\Http\Messaging\V1\Entity\WhiteList;
...
class Values extends Entity implements Collection
{
    /**
    ...
    {
        throw new LogicException('Item values list is read only.');
    }
